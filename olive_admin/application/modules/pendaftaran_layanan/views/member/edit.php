					...
					<form id="form_member">
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									<h5>Kode Member</h5>
									<input type="text" id="kode_member" name="kode_member" value="<?php echo $get_member->kode_member; ?>" class="form-control" placeholder="kode member" readonly>
							...
							<div class="row">
								<div class="col-md-6">
									<h5>Keterangan</h5>
									<input type="text" id="keterangan" name="keterangan" value="<?php echo $get_member->keterangan; ?>" class="form-control" placeholder="keterangan">
								</div>
								<div class="col-md-6">
									<h5>Status FEE</h5>
							...
							<div class="row">
								<div class="col-md-6 nominal_fee" style="display: none;">
									<h5>Nominal FEE</h5>
									<input type="text" id="nominal_fee" name="nominal_fee" value="<?php echo $get_member->nominal_fee; ?>" class="form-control" placeholder="Nominal Fee">
								</div>
								<div class="col-md-6">
									<h5>Harga</h5>
								...
								<div class="col-md-6">
									<h5>Ongkos Kirim</h5>
									<input type="text" id="ongkir" name="ongkir" value="<?php echo $get_member->ongkir; ?>" class="form-control" placeholder="Ongkos Kirim">
								</div>
								<div class="col-md-6">
									<h5>Status</h5>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<input type="text" id="nama_perusahaan" value="<?= @$get_member->nama_perusahaan ?>" name="nama_perusahaan" class="form-control" placeholder="Nama Perusahaan">
								</div>
								<div class="col-md-6">
									<h5>Alamat Perusahaan</h5>
									<input type="text" id="alamat_perusahaan" value="<?= @$get_member->alamat_perusahaan ?>" name="alamat_perusahaan" class="form-control" placeholder="Alamat Perusahaan">
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<h5>Telepon Perusahaan</h5>
									<input type="text" id="telp_perusahaan" value="<?= @$get_member->telp_perusahaan ?>" name="telp_perusahaan" class="form-control" placeholder="Telepon Perusahaan">
								</div>
								<div class="col-md-6">
									<h5>No. Rekening Perusahaan</h5>
									<input type="text" id="no_rek_perusahaan" name="no_rek_perusahaan" value="<?= @$get_member->no_rek_perusahaan ?>" class="form-control" placeholder="No. Rekening Perusahaan">
								</div>
							</div>
							<div class="row"><br>
								<h3>B. Data PIC</h3>
							...
							<div class="row">
								<div class="col-md-6">
									<h5>Nama PIC</h5>
									<input type="text" id="nama_pic" name="nama_pic" value="<?= @$get_member->no_rek_perusahaan ?>" class="form-control" placeholder="Nama PIC">
								</div>
								<div class="col-md-6">
									<h5>Alamat PIC</h5>
									<input type="text" id="alamat_pic" name="alamat_pic" value="<?= @$get_member->alamat_pic ?>" class="form-control" placeholder="Alamat PIC">
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<h5>Telepon PIC</h5>
									<input type="text" id="telp_pic" name="telp_pic" value="<?= @$get_member->telp_pic ?>" class="form-control" placeholder="Telepon PIC">
								</div>
								<div class="col-md-6">
									<h5>No. Rekening PIC</h5>
									<input type="text" id="no_rek_pic" name="no_rek_pic" value="<?= @$get_member->no_rek_pic ?>" class="form-control" placeholder="No. Rekening PIC">
								</div>
							</div>
							<div class="row"><br>
								<hr>
...
<script type="text/javascript">
	...
	$("#form_member").submit( function() {  
		...
		if (kode_member != '' && kategori_member != '' && status_fee != '' && kategori_harga != '' && ongkir != '' && nama_perusahaan != '' && telp_perusahaan != '' && no_rek_perusahaan != '' && nama_pic != '' && telp_pic != '' && no_rek_pic != '') {
			$.ajax( {  
				type :"post",  
				url : "<?php echo base_url() . 'penjualan/member/update_member' ?>",  
				cache :false,  
				data :$(this).serialize(),
				dataType: 'Json',
				beforeSend:function(){
