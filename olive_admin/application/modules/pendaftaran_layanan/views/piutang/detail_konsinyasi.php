		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-right">
					<span class="pull-left" style="font-size: 24px">Detail Piutang Konsinyasi</span>
							...
							<tbody id="data_opsi_perencanaan">
								...
								foreach ($hasil_piutang as $piutang) {
									...
									<tr>
										...
										<td>
											<a href="<?= base_url('penjualan/piutang/detail_pertransaksi_konsinyasi/'.$kode_member.'/'.$piutang->kode_piutang); ?>" class="btn btn-success btn-sm btn-no-radius"><i class="fa fa-search"></i> Detail</a>
											<a href="<?= base_url('penjualan/piutang/angsur_konsinyasi/'.$kode_member.'/'.$piutang->kode_piutang); ?>" class="btn btn-info btn-sm btn-no-radius">Angsur</a>
