...
class data_dokter extends MY_Controller {
	...
	{
           $data['konten'] = $this->load->view('dokter/data_dokter/daftar', NULL, TRUE);
	...
	{
           $data['konten'] = $this->load->view('dokter/data_dokter/tambah', NULL, TRUE);
           $this->load->view ('admin/main', $data);
	}

	public function edit()
	{
           $data['konten'] = $this->load->view('dokter/data_dokter/edit', NULL, TRUE);
           $this->load->view ('admin/main', $data);
	}
	public function detail()
	{
           $data['konten'] = $this->load->view('dokter/data_dokter/detail', NULL, TRUE);
           $this->load->view ('admin/main', $data);
	}
