							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text"  class="form-control" placeholder="Kode " name="kode_periksa" id="kode_periksa" />
									</div>

									<div class="form-group">
										<label class="gedhi"><b>Harga Periksa</label>
										<div class="input-group">
											<span class="input-group-addon rp_harga">Rp 60.000,00</span>
											<input type="number" class="form-control input-group" onkeyup="get_nominal_harga()" name="harga_periksa" id="harga_periksa" />
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Nama Periksa"  name="nama_periksa" id="nama_periksa"/>
									</div>
