				...
				<div class="panel-body">
					<form id="data_form" action="" method="post">
						<div class="box-body">
							...
							<label><h3><b>Tambah Paket</b></h3></label>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Kode Paket</label>
										<input  type="text" value="" class="form-control" placeholder="Kode " name="kode_paket" id="kode_paket" />
									</div>
								...
								<div class=" form-group col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Nama paket" value="" name="nama_paket" id="nama_paket"/>
									</div>
								</div>
								...
								<div class="">
									<div class="form-group  col-md-6">
										<label class="gedhi"><b>Harga Jual</label>
											<div class="input-group">
												...
												<input required type="number" class="form-control input-group" onkeyup="get_nominal_harga_paket()" name="harga_paket" id="harga_paket" value="" />
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="HPP" value="" name="harga_promo" id="harga_promo" onkeyup="get_harga_promo()" readonly="true"/>
										</div>
									</div>
