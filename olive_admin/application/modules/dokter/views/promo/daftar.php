								...
								<table id="datatable" class="table table-striped table-bordered">
									...
									<tbody id="scroll_data">
										...
										<tr>
											...
											<td align="center">
												<div class="btn-group">
													<a href="<?php echo base_url('setting/promo/detail') ?>" id="detail" data-toggle="tooltip" title="Detail" class="btn btn-primary btn-circle green"><i class="fa fa-search"></i></a>
													<a href="<?php echo base_url('setting/promo/edit') ?>" key="8" id="ubah" data-toggle="tooltip" title="Edit" class="btn btn-warning btn-circle yellow"><i class="fa fa-pencil"></i></a>
