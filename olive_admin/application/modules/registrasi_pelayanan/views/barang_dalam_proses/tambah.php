		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-right">
					<span class="pull-left" style="font-size: 24px">Tambah Barang Dalam Proses </span>
				...
				$get_max_id=$this->db2->get('master_barang_dalam_proses');
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-5">
									...
									<input type="text" class="form-control" id="kode_barang" name="kode_barang" placeholder="Kode Bahan Baku" readonly aria-describedby="basic-addon1" value="BDP_<?php echo get_kode(@$hasil_max_id->id, 6); ?>">
								</div>
								<div class="col-md-5">
							...
							<div class="row">
								<div class="col-md-5">
									...
									<input type="text" class="form-control" id="nama_barang" name="nama_barang" placeholder="Nama Barang"  aria-describedby="basic-addon1">
								</div>
								<div class="col-md-5">
							...
							<div class="row">
								...
								<div class="col-md-5">
									...
									<input type="number" class="form-control" placeholder="Stok Minimal" onkeyup="cek_minimal()" id="stok_minimal" name="stok_minimal" aria-describedby="basic-addon1">
								</div>
							</div><br>
...
<script type="text/javascript">
	...
	function simpan_bdp() {
		...
		$.ajax({
			url: '<?php echo base_url('master/barang_dalam_proses/simpan_bdp'); ?>',
			type: 'post',
