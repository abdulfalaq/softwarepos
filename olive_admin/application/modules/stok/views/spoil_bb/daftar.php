				...
				<div class="panel-body">
					<div class="col-md-12 row">
						<table id="datatable" class="table table-striped table-bordered">
							...
							<tbody>    
								<?php 
								$this->db->where('kan_suol.transaksi_spoil.jenis_bahan','BB');
								...
								foreach ($hasil_spoil as $spoil) { 
									...
									<tr>
										...
										<td>
											<a href="<?php echo base_url('stok/spoil_bb/detail/'.@$spoil->kode_spoil);?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
										</td>
									</tr>
									<?php }
									?>
