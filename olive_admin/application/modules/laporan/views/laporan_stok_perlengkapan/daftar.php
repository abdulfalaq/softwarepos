...
<div class="container">
	<ol class="breadcrumb">
		...
		<li><a href="#">Laporan Stok Perlengkapan</a></li>
		<li></li>
	</ol>
</div>
...
<div class="container">
	<h1>Laporan Stok Perlengkapan</h1>
							...
							<table class="table table-striped table-hover table-bordered" id="datatable"  style="font-size:1.0em;">
								...
								<tbody>
									...
									foreach ($get_bahan as $value) { $no++; 
										...
										$this->db->where('clouoid1_olive_gudang.transaksi_stok.kode_bahan',$value->kode_perlengkapan);
	...
	<script type="text/javascript">
		$("#print").click(function(){
			...
			window.open("<?php echo base_url().'laporan/laporan_stok_perlengkapan/print_stok_perlengkapan/'; ?>"+tgl_awal+"/"+tgl_akhir);
		});
		...
		function cari_stok_day(){
			...
			if (tgl_awal != '' && tgl_akhir != '') {
				$.ajax({
					url: '<?php echo base_url('laporan/laporan_stok_perlengkapan/load_data_cari'); ?>',
					type: 'post',
