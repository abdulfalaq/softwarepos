					...
					<form id="formGudang">
						<div class="form-body">
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" name="kode_semen_beku" id="kode_semen_beku" required="">
							</div>
							<div class="form-group col-md-6">
								<label class="control-label">Nama Pejantan</label>

								<input type="text" class="form-control" name="nama_pejantan" id="nama_pejantan" required="">
							</div>
							<div class="form-group col-md-6">
								<label class="control-label">ID Dam</label>
								<input type="text" class="form-control" name="id_dam" id="id_dam" required="">
							</div>
							<div class="form-group col-md-6">
								<label class="control-label">Nama Dam</label>
								<input type="text" class="form-control" name="nama_dam" id="nama_dam" required="">
							</div>
							<div class="form-group col-md-6">
								<label class="control-label">ID Sire</label>
								<input type="text" class="form-control" name="id_sire" id="id_sire" required="">
							</div>
							<div class="form-group col-md-6">
								<label class="control-label">Nama Sire</label>
								<input type="text" class="form-control" name="nama_sire" id="nama_sire" required="">
							</div>
							<div class="form-group col-md-6">
							...
							<div class="form-group col-md-6">
								...
								<select class="form-control" id="kode_satuan_stok" name="kode_satuan_stok" required="">
...
<script type="text/javascript">
	...
	$("#formGudang").submit( function() {  
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'master/semen_beku/simpan_member' ?>",  
			cache :false,  
			data :$(this).serialize(),
			dataType: 'Json',
			beforeSend:function(){
