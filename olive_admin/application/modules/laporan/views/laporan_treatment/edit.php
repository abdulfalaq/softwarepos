					...
					<form id="formGudang">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<input type="text" value="<?php echo $get_gudang->nama_gudang?>" class="form-control" name="nama_gudang" id="nama_gudang" required="" >
							</div>
							<div class="form-group">
								<label>Keterangan</label>
								<input type="text" value="<?php echo $get_gudang->keterangan?>" class="form-control" name="keterangan" id="keterangan" required="" >
							</div>
							<div class="form-group">
								<label>Status</label>
...
<script type="text/javascript">
	...
	$("#formGudang").submit( function() {  
		...
		status 		= $('#status').val(); 
		if (kode_gudang != '' && nama_gudang != '' && keterangan != '' && status != '') {
			$.ajax( {  
				type :"post",  
				url : "<?php echo base_url() . 'master/gudang/update_member' ?>",  
				cache :false,  
				data :$(this).serialize(),
				dataType: 'Json',
				beforeSend:function(){
