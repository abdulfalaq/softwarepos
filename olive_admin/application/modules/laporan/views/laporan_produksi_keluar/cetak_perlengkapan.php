			...
			<tbody>
				...
				foreach ($data_item as $item) {
					...
					foreach ($get_data as  $data) {
						...
						$this->db->where('olive_kasir.transaksi_layanan.tanggal_transaksi >=',@$data['tgl_awal']);
						$this->db->where('olive_kasir.transaksi_layanan.tanggal_transaksi <=',@$data['tgl_akhir']);
