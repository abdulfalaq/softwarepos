...
$get_kategori = $this->db_master->get('master_kategori_penyakit')->result();
?>
		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-right">
					<span class="pull-left" style="font-size: 24px">Data Kategori Penyakit</span>
							...
							<table class="table table-striped table-hover table-bordered" id="datatable">
								...
								<tbody>
									...
									foreach ($get_kategori as $value) { 
										...
										<td>
											<div class="btn-group">
												<a class="btn btn-primary" href="<?php echo base_url('master/kategori_penyakit/detail/'.$value->id); ?>"><i class="fa fa-search"></i></a>
												<a class="btn btn-warning" href="<?php echo base_url('master/kategori_penyakit/edit/'.$value->id); ?>"><i class="fa fa-pencil"></i></a>
												<a id="hapus" onclick="actDelete('<?= $value->id ?>')" data-toggle="tooltip" title="Delete" class="btn btn-danger btn-circle red"><i class="fa fa-remove"></i></a>
											</div>
										</td>
									</tr>
									<?php } ?>
...
<script type="text/javascript">
	...
	function hapus_data() {
		var id=$('#id').val();
		$.ajax({
			url: '<?php echo base_url('master/kategori_penyakit/hapus'); ?>',
			type: 'post',
			data:{id:id},
			beforeSend:function(){
				$(".tunggu").show();
