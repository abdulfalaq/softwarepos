		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-right">
					<span class="pull-left" style="font-size: 24px">Input Master Breed</span>
					...
					<form id="data_form">
						<div class="form-body">
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" required name="nama_breed" id="nama_breed" value="" placeholder="Breed">
							</div>
							<div class="form-group col-md-6">
...
<script type="text/javascript">
	$(function () {  
		$("#data_form").submit( function() {
			$.ajax( {  
				type :"post",  
				url : "<?php echo base_url() . 'master/master_breed/simpan' ?>",  
				cache :false,  
				data :$(this).serialize(),
				dataType: 'Json',
				beforeSend:function(){
