		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-right">
					<span class="pull-left" style="font-size: 24px">Data Hasil Produksi </span>
							...
							<tbody id="data_opsi_perintah">
								...
								foreach ($hasil_produksi as $produksi) {
									...
									<tr>
										...
										<td>
											<a href="<?php echo base_url('produksi/produksi/detail')."/".$produksi->kode_produksi; ?>" class="btn btn-success"><i class="fa fa-eye"></i> </a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
