	...
	<div class="row" style="margin-top:20px;">
		<div class="col-sm-12">			
			<div class="col-md-8 form_shadow">
				...
				$kode_penjualan_baru=@$arrar_kode[0].'_'.date('ymdhis');
				...
				<div class="row" style="margin-right: 10px">
					...
					<div class="col-md-7">
						...
						<input type="text" name="kode_transaksi_baru" id="kode_transaksi_baru" value="<?php echo $kode_penjualan_baru;?>" hidden/>
						...
						<div class="col-md-12 btn btn-md btn-no-radius btn-success btn-shadow nama_member" style="padding-left: 0px ;margin-top: 10px">
					...
					<div class="col-md-3" style="padding: 0">
						...
						<a onclick="rekam_medis()">
							<div id="rekam" class="btn btn-md btn-primary btn-no-radius btn-shadow" style="width: 100%;margin-top: 10px;">REKAM MEDIS</div>
						</a>
					</div>
				</div>
			</form><hr><hr>
			...
			<?php
			if(@$get_list->kode_layanan=='01' || @$get_list->kode_layanan=='02'){
				?>
				<div id="tabel1">
...
<div  class="col-md-4" id="tabel3">
	...
	<div class="btn btn-success btn-lg  btn-no-radius btn-shadow data_kasir bayar_transaksi" onclick="simpan_transaksi()" style="width: 100%; margin: 5px; margin-left: 0 ">BAYAR</div>
	<div class="btn btn-warning btn-lg  btn-no-radius btn-shadow data_kasir simpan_batal_transaksi" onclick="simpan_batal_transaksi()" style="width: 100%; margin: 5px; margin-left: 0 ">BATAL TRANSAKSI</div>
	<div class="btn btn-danger btn-lg  btn-no-radius btn-shadow data_kasir" onclick="batal_transaksi()" style="width: 100%; margin: 5px; margin-left: 0 ">CANCEL</div>
	<br>
</div>
</div>
</div>
...
<script type="text/javascript">
	function rekam_medis() {
		...
		$('#data_rekam_medis').load('<?php echo base_url('daftar_transaksi/table_rekam_medis'); ?>/'+kode_member);
	}
	...
	function list_transaksi() {
		...
		$('#data_list_transaksi').load('<?php echo base_url('daftar_transaksi/table_list_transaksi'); ?>');
	}
	function cari_list_filter() {
		var tgl_awal=$('#tgl_awal').val();
		var tgl_akhir=$('#tgl_akhir').val();
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/table_list_transaksi'); ?>',
			type: 'post',
	...
	function get_data_member() {
		var kode_member=$('#kode_member').val();
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/get_data_member'); ?>',
			type: 'post',
	...
	function join_member_layanan() {
		...
		if(kode_member==''){
			...
			$.ajax({
				url: '<?php echo base_url('daftar_transaksi/simpan_kartu_member_layanan'); ?>',
				type: 'post',
	...
	function cancel_join_member_layanan() {
		...
		var kode_member=$('#kode_member').val();
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/delete_kartu_member_layanan'); ?>',
			type: 'post',
			data:{kode_transaksi:kode_transaksi,kode_member:kode_member},
			success: function(hasil){
				$('#join_member').show();
	...
	function get_data_layanan() {
		...
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/get_data_layanan'); ?>',
			type: 'post',
	...
	function get_data_produk() {
		...
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/get_data_produk'); ?>',
			type: 'post',
	...
	function load_table_temp() {
		var kode_transaksi=$('#kode_transaksi').val();
		$('#tb_pesan_temp_layanan').load('<?php echo base_url('daftar_transaksi/table_pesan_temp'); ?>/'+kode_transaksi+'/Treatment');

		$('#tb_pesan_temp').load('<?php echo base_url('daftar_transaksi/table_pesan_temp'); ?>/'+kode_transaksi+'/produk');
		get_total_pesanan();
	}
	...
	function simpan_layanan() {
		...
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/simpan_layanan'); ?>',
			type: 'post',
	...
	function simpan_pesanan_opsi() {
		...
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/simpan_pesanan_temp'); ?>',
			type: 'post',
	...
	function actDelete(key) {
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/hapus_temp'); ?>',
			type: 'post',
			data:{id:key},
			success: function(hasil){
				load_table_temp();
	...
	function actEdit(key) {
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/get_data_opsi'); ?>',
			type: 'post',
			data:{id:key},
			dataType:'json',
			success: function(hasil){
	...
	function update_pesanan_opsi() {
		...
		var jenis_item=$('#jenis_item').val();
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/update_pesanan_opsi'); ?>',
			type: 'post',
	...
	function update_layanan() {
		...
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/update_layanan'); ?>',
			type: 'post',
			data:{id_temp:id_temp,kode_menu:kode_menu,qty:qty,harga:harga,jenis_diskon:jenis_diskon,diskon_item:diskon_item,kode_terapis:kode_terapis,jenis_item:jenis_item},
			dataType:'json',
			success: function(hasil){
	...
	function get_total_pesanan() {
		...
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/get_total_pesanan_layanan'); ?>',
			type: 'post',
			...
			success: function(hasil){
				...
				if(parseInt(hasil.total_item) <=0){
					$('.simpan_batal_transaksi').show();
					$('.bayar_transaksi').hide();
					$('#jenis_diskon_transaksi').attr("disabled",true);
					$('#diskon_transaksi').attr("disabled",true);
					$('#diskon_transaksi').val('');
					$('#kategori_diskon').attr("disabled",true);
					$('#kategori_diskon').val('');
					$('#jenis_transaksi').attr("disabled",true);
					$('#jenis_transaksi').val('tunai');
					$('#dibayar').attr("disabled",true);
					$('#dibayar').val('');
				}else{
					$('.simpan_batal_transaksi').hide();
					$('.bayar_transaksi').show();
					$('#jenis_diskon_transaksi').attr("disabled",false);
					$('#diskon_transaksi').attr("disabled",false);
					$('#diskon_transaksi').val('');
					$('#kategori_diskon').attr("disabled",false);
					$('#kategori_diskon').val('');
	...
	function batal_transaksi() {
		var kode_transaksi=$('#kode_transaksi').val();
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/delete_transaksi'); ?>',
			type: 'post',
			...
			success: function(hasil){
				window.location="<?php echo base_url('daftar_transaksi/daftar_transaksi'); ?>";
			}
		});
	}
	function simpan_transaksi() {
		var kode_transaksi=$('#kode_transaksi').val();
		var kode_transaksi_baru=$('#kode_transaksi_baru').val();
		...
		if(total_pesanan==''){
			...
			$.ajax({
				url: '<?php echo base_url('daftar_transaksi/simpan_transaksi'); ?>',
				type: 'post',
				data:{
				...
				success: function(hasil){
					print_invoice();
					$(".sukses").html(data);
					window.location="<?php echo base_url('daftar_transaksi'); ?>";

				}
			});
		}
	}
	function simpan_batal_transaksi() {
		var kode_transaksi=$('#kode_transaksi').val();
		var kode_member=$('#kode_member').val();
		$.ajax({
			url: '<?php echo base_url('daftar_transaksi/simpan_batal_transaksi'); ?>',
			type: 'post',
			data:{
				kode_transaksi:kode_transaksi,
				kode_member:kode_member
	...
	function print_invoice(){
		...
		$.ajax({
			...
			type: 'post',
			data:{kode_transaksi:kode_transaksi_baru},
			success: function(hasil){
