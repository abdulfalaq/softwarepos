...
$this->db->select('clouoid1_olive_kasir.opsi_transaksi_batal_temp.id');
...
$this->db->select('clouoid1_olive_master.master_karyawan.nama_karyawan');
...
$this->db->join('clouoid1_olive_master.master_karyawan', 'clouoid1_olive_kasir.opsi_transaksi_batal_temp.kode_terapis = clouoid1_olive_master.master_karyawan.kode_karyawan', 'left');
