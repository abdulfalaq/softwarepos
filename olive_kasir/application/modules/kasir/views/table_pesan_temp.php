...
$this->db->join('clouoid1_olive_master.master_karyawan', 'clouoid1_olive_kasir.opsi_transaksi_layanan_temp.kode_terapis = clouoid1_olive_master.master_karyawan.kode_karyawan', 'left');
