	...
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-default">
				...
				$get_max_id=$this->db2->get('master_produk');
				$hasil_max_id=$get_max_id->row();
				?>
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-6">
									...
									<input type="text" class="form-control data_produk" id="kode_produk" name="kode_produk" placeholder="Kode Bahan Baku" readonly  value="PRO_<?php echo get_kode(@$hasil_max_id->id, 6); ?>">
								</div>
								<div class="col-md-6">
									<label for="">Nama Produk</label>
									<input type="text" class="form-control data_produk" id="nama_produk" name="nama_produk" placeholder="Nama Produk"  >
								</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<select name="kode_gudang" id="kode_gudang" class="form-control data_produk">
										...
										foreach ($get_satuan as $value) { ?>
										<option value="<?= $value->kode_gudang ?>"><?= $value->nama_gudang ?></option>
										<?php }
										?>
									</select>
								</div>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<input type="number" class="form-control data_produk" placeholder="Stok Minimal" onkeyup="cek_minimal()" id="stok_minimal" name="stok_minimal" >
								</div>
								<div class="col-md-3">
									<label for="">Harga 1</label>
									<input type="number" class="form-control harga data_produk" placeholder="Harga 1" id="harga1" name="harga1" >
								</div>
								<div class="col-md-3">
									<label for="">Harga 2</label>
									<input type="number" class="form-control harga data_produk" placeholder="Harga 2" id="harga2" name="harga2" >
								</div>
							</div><br>
							<div class="row">
								...
								<div class="col-md-3">
									...
									<input type="number" class="form-control harga data_produk" placeholder="Harga 3" id="harga3" name="harga3" >
								</div>
								<div class="col-md-3">
									<label for="">Harga 4</label>
									<input type="number" class="form-control harga data_produk" placeholder="Harga 4" id="harga4" name="harga4" >
								</div>
								<div class="col-md-3">
									<label for="">Harga 5</label>
									<input type="number" class="form-control harga data_produk" placeholder="Harga 5" id="harga5" name="harga5" >
								</div>
								<div class="col-md-3">
									<label for="">Harga 6</label>
									<input type="number" class="form-control harga data_produk" placeholder="Harga 6" id="harga6" name="harga6" >
								</div>
							</div><br>
							<div class="row">
								<div class="col-md-3">
									<label for="">Harga 7</label>
									<input type="number" class="form-control harga data_produk" placeholder="Harga 7" id="harga7" name="harga7" >
								</div>
								<div class="col-md-3">
									<label for="">Harga 8</label>
									<input type="number" class="form-control harga data_produk" placeholder="Harga 8" id="harga8" name="harga8" >
								</div>
								<div class="col-md-3">
									<label for="">Harga 9</label>
									<input type="number" class="form-control harga data_produk" placeholder="Harga 9" id="harga9" name="harga9" >
								</div>
								<div class="col-md-3">
									<label for="">Harga 10</label>
									<input type="number" class="form-control harga data_produk" placeholder="Harga 10" id="harga10" name="harga10" >
								</div>
							</div><br>
...
<script type="text/javascript">
	...
	function simpan_produk() {
		...
		$.ajax({
			url: '<?php echo base_url('master/produk/simpan_produk'); ?>',
			type: 'post',
