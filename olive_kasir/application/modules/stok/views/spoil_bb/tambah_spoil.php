						...
						<div class="col-md-12 row">
							...
							<table id="" class="table table-striped table-bordered">
								...
								<tbody>  
									...
									$this->db->where('kan_suol.opsi_transaksi_spoil_temp.jenis_bahan','BB');
									$this->db->from('kan_suol.opsi_transaksi_spoil_temp');
									$this->db->join('kan_master.master_bahan_baku', 'kan_suol.opsi_transaksi_spoil_temp.kode_bahan = kan_master.master_bahan_baku.kode_bahan_baku','left');
...
<script type="text/javascript">
	...
	function simpan_spoil(){
		...
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'stok/spoil_bb/simpan_transaksi_spoil' ?>",  
			cache :false,  
			...
			success : function(data) { 
				...
				$(".alert_berhasil").show();
				setTimeout(function(){
					window.location="<?php echo base_url('stok/spoil_bb/daftar');?>";
				},1500);
			},  
			error : function() {
