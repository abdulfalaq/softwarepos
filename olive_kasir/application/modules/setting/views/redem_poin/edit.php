						...
						<div class="box-body">            
							<div class="row">
								<div class="form-group  col-xs-5">
									...
									<input type="hidden" name="id" id="id" class="form-control" value="<?php echo $get_gudang->id?>" >
									<input  required value="<?php echo $get_gudang->jenis_produk?>"  type="text" class="form-control" name="jenis_produk" />
								</div>

								<div class="form-group  col-xs-5">
									<label class="gedhi"><b>Kode Produk</b></label>
									<input  required value="<?php echo $get_gudang->kode_produk?>"  type="text" class="form-control" name="kode_produk" />
								</div>
								<div class="form-group  col-xs-5">
									<label class="gedhi"><b>Setara Poin</b></label>
									<input  required value="<?php echo $get_gudang->setara_poin?>" type="text" value="<?php echo $get_gudang->setara_poin?>"  class="form-control" name="setara_poin" />
								</div>
							</div>
...
<script type="text/javascript">
	$('#data_form').submit(function(){
		$.ajax({
			type: 'post',
			url: '<?php echo base_url('setting/redem_poin/update'); ?>',
			cache: false,
			data: $(this).serialize(),
			dataType: 'Json',
			beforeSend:function(){
