...
class transaksi_kasir extends MY_Controller {
	...
	{
           $data['konten'] = $this->load->view('transaksi_kasir', NULL, TRUE);
	...
	public function search_data_by_date(){
		$this->load->view('data_by_date');
	}

	public function validate_data_transaksi(){
		$kode_transaksi = $this->input->post('kode_transaksi');

		$update_data['validasi'] = 'valid'; 
		$update_data['status'] = 'close'; 
		$this->db->where('kode_transaksi', $kode_transaksi);
		$updated = $this->db->update('transaksi_kasir', $update_data);
		if ($updated) {
