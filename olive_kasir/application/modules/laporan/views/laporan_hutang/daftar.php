		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-left">
					<span style="font-size: 24px">Data Laporan Hutang </span>
				</div>
...
function get_report_perbulan () {
	...
	$.ajax({
		url: '<?php echo base_url('laporan/laporan_hutang/filtering_report'); ?>',
		type: 'post',
...
function print_out(){
		...
		var tahun 		= $("#tahun").val();
		if (bulan != '' && tahun != '') {
			window.open("<?php echo base_url() . 'laporan/laporan_hutang/print_out_data/'; ?>"+bulan+"/"+tahun);
		}
	}
</script>
