		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-right">
					<span class="pull-left" style="font-size: 24px">Tambah Gudang </span>
					...
					<form id="formGudang">
						<div class="row">
							<div class="col-sm-6">
								...
								<input type="text" readonly value="GD_<?= get_kode(@$get_last_id->id,6); ?>" name="kode_gudang" id="kode_gudang" class="form-control" required="">
							</div>
							<div class="col-sm-6">
...
<script type="text/javascript">
	...
	$("#formGudang").submit( function() {  
		...
		if (nama_gudang != '' && keterangan != '' && status != '') {
			$.ajax( {  
				type :"post",  
				url : "<?php echo base_url() . 'master/gudang/simpan_gudang' ?>",  
				cache :false,  
				data :$(this).serialize(),
				dataType: 'Json',
				beforeSend:function(){
