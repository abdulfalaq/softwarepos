...
$simpanan = $this->db->get_where('master_simpanan_pokok',array('id'=>$id))->row();
?>
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-heading text-right">
						<span class="pull-left" style="font-size: 24px">Edit Produk Simpanan Pokok</span>
							...
							<tr>
								...
								<td>
									<div class="input-group">
										...
										<input type="number" name="nominal" id="nominal" required="" class="form-control" value="<?php echo $simpanan->nominal_simpanan_pokok; ?>">
									</div>
								</td>
							</tr>
							<tr>
...
<script type="text/javascript">
	...
	$('#form').submit(function(){		
		$.ajax({
			url: '<?php echo base_url('setting/produk_simpanan_pokok/act_update'); ?>',
			type: 'post',
			data: $(this).serialize(),
			beforeSend: function(){
				$('.tunggu').show();
