			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-heading text-right">
						<span class="pull-left" style="font-size: 24px">Tambah Produk Simpanan wajib</span>
					...
					<div class="panel-body">
						<table class="table-form" width="100%">
							<tr>
								<td>Kode</td>
								<td>
									<input type="text" name="kode" id="kode" required="" class="form-control" value="<?php echo "KSW_".date('ymdhis'); ?>" readonly="">
								</td>
							</tr>
							<tr>
...
<script type="text/javascript">
	...
	$('#form').submit(function(){		
		$.ajax({
			url: '<?php echo base_url('setting/produk_simpanan_wajib/act_simpan'); ?>',
			type: 'post',
			data: $(this).serialize(),
			beforeSend: function(){
				$('.tunggu').show();
