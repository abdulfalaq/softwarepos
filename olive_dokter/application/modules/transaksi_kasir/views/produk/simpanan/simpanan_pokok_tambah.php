			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-heading text-right">
						<span class="pull-left" style="font-size: 24px">Tambah Produk Simpanan Pokok</span>
					...
					<div class="panel-body">
						<table class="table-form" width="100%">
							<tr>
								<td>Kode</td>
								<td>
									<input type="text" name="kode" id="kode" required="" class="form-control" value="<?php echo "KSP_".date('ymdhis'); ?>" readonly="">
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="input-group">
										...
										<input type="number" name="nominal" id="nominal" required="" class="form-control">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="date" name="tanggal_aktivasi" id="tanggal_aktivasi" required="" class="form-control" value="<?php echo date('Y-m-d'); ?>">
								</td>
							</tr>
						</table>
					</div>
					<div class="panel-footer text-right">
						<button class="btn btn-lg btn-super btn-no-radius btn-danger"><i class="fa fa-save"></i> SIMPAN</button>
					</div>
				</div>
			</div>
		</div> <!-- //row -->
...
<script type="text/javascript">
	...
	$('#form').submit(function(){		
		$.ajax({
			url: '<?php echo base_url('setting/produk_simpanan_pokok/act_simpan'); ?>',
			type: 'post',
			data: $(this).serialize(),
			beforeSend: function(){
				$('.tunggu').show();
			...
			success: function(response){
				if(response == "success"){
					...
					$('.alert_berhasil').show();
					setTimeout(function(){
						window.location.href='<?php echo base_url('setting/produk_simpanan_pokok'); ?>';
					},1000);	
				}else{
