							...
							<div class="row">
								<div class="form-group  col-xs-5">
									<label class="gedhi"><b>Nominal Poin</label>
										<input ="" required value="1" type="text" class="form-control" name="nominal_poin" />
									</div>
									<div class="form-group  col-xs-5">
										<label class="gedhi"><b>Nominal Transaksi</label>
											<input ="" required value="Rp 100.000,00" type="text" class="form-control" name="nominal_transaksi" />
										</div>
									</div>
								</div>
