...
$this->db_olive->where('kode_perawatan',$kode_perawatan);
$get_gudang = $this->db_olive->get('master_perawatan')->row();
?>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<input type="text" disabled="" class="form-control" placeholder="Nama Perawatan" value="<?php echo $get_gudang->nama_perawatan ?>" name="nama_perawatan" id="nama_perawatan" required=""/>
									</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="number" disabled="" class="form-control input-group" onkeyup="get_nominal_hpp()" name="harga_jual" id="harga_jual" value="<?php echo $get_gudang->harga_jual ?>" required=""/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="number" disabled="" class="form-control input-group" onkeyup="get_insentif()" name="insentif_terapi" id="insentif_terapi" value="<?php echo $get_gudang->insentif_terapi ?>"  required="" />
										</div>
									</div>								
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" disabled="" class="form-control" placeholder="HPP" value="<?php echo format_rupiah($get_gudang->hpp) ?>" name="hpp" id="hpp"  readonly=""  / >
									</div>
								</div>
								<div class="col-md-6">								
									<div class="form-group">
										<label>Status</label>
										<select class="form-control" disabled="" name="status" id="status" required="">
								...
								<div class="form-group  col-xs-5">
									<label><b>Redem Poin</label>
										<input  type="number" class="form-control" value="<?php echo $get_gudang->redeem_poin ?>"  style="width:630px " name="redeem_poin" id="redeem_poin" disabled="" />
									</div>
								</div>
							</form>
						</div>
					...
					<!-- <div id="bottom" style="margin-top: 30px">
							...
							<div class="row">
								<div class="col-md-12" style="margin-top: 30px">  
									...
									<div class="col-md-2">
										...
										<select class="form-control" disabled="" id="jenis" name="jenis">
									...
									<div class="col-md-2" id="bahan">
										<label>Bahan</label>
										<input type="text" disabled="" class="form-control" placeholder="Bahan" name="nama_satuan" disabled="" id="nama_satuan" />
									</div>

									<div class="col-md-2" id="bahan_baku">
										<label>Nama Bahan</label>
										<select id="kode_bahan" disabled="" name="kode_bahan" class="form-control" style="width: 100%">
											<option value="">--Pilih Bahan--</option>
											<?php  
											$get_paket = $this->db_olive->get('master_bahan_baku')->result();
									...
									<div class="col-md-2" id="peralatan">
										...
										<select id="kode_perlengkapan" disabled="" name="kode_perlengkapan" class="form-control " style="width: 100%">
											<option value="">--Pilih Perlengkapan--</option>
											<?php  
											$get_butung = $this->db_olive->get('master_perlengkapan')->result();
									...
									<div class="col-md-2">
										<label>Jumlah</label>
										<input type="text" disabled="" class="form-control" placeholder="Jumlah" name="jumlah" id="jumlah"/>
									...
									<div class="col-md-2">
										<label>HPP</label>
										<input type="text" readonly="true" class="form-control" placeholder="Hpp" name="hpp" id="hpp_total"/>
						...
						<div id="list_transaksi_pembelian">
							<div class="box-body komposisi_perawatan">
								...
								<div id="oraight">
									<?php 
									$this->db_olive->from('opsi_master_perawatan');
									$this->db_olive->select('opsi_master_perawatan.hpp');
									$this->db_olive->select('opsi_master_perawatan.kode_perawatan');
									$this->db_olive->select('opsi_master_perawatan.id');
									$this->db_olive->select('opsi_master_perawatan.jenis');
									$this->db_olive->select('opsi_master_perawatan.qty');
									$this->db_olive->select('master_perlengkapan.nama_perlengkapan');
									$this->db_olive->select('master_bahan_baku.nama_bahan_baku');


									$this->db_olive->join('master_perlengkapan','master_perlengkapan.kode_perlengkapan = opsi_master_perawatan.kode_perlengkapan','Left');
									$this->db_olive->join('master_bahan_baku','master_bahan_baku.kode_bahan_baku = opsi_master_perawatan.kode_bahan','Left');

									$this->db_olive->where('opsi_master_perawatan.kode_perawatan',$get_gudang->kode_perawatan);
	...
	<script type="text/javascript">
		...
		function update_perawatan(){
			...
			$.ajax( {  
				...
				cache :false,  
				data :{kode_perawatan:kode_perawatan,kode_bahan:kode_bahan,kode_perlengkapan:kode_perlengkapan,qty:jumlah,satuan:satuan,hpp:hpp,jenis:jenis,status:status,insentif_terapi:insentif_terapi,harga_jual,harga_jual,nama_perawatan:nama_perawatan},
				dataType: 'Json',
				beforeSend:function(){
					$(".tunggu").show();   
				},
