							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input  type="text" value="" class="form-control"  onchange="cek_kode()" placeholder="Kode Perawatan " name="kode_perawatan" id="kode_perawatan" required=""  />
									</div>
									<div class="form-group">
										<label class="gedhi">Nama Perawatan</label>
										<input type="text" class="form-control" placeholder="Nama Perawatan" value="" name="nama_perawatan" id="nama_perawatan" required=""/>
									</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="number" class="form-control input-group" onkeyup="get_nominal_hpp()" name="harga_jual" id="harga_jual" value="" required=""/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="number" class="form-control input-group" onkeyup="get_insentif()" name="insentif_terapi" id="insentif_terapi" value="" required="" />
										</div>
									</div>								
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="HPP" value="" name="hpp" id="hpp"  readonly=""  / >
									</div>
								</div>
								<div class="col-md-6">								
									<div class="form-group">
								...
								<div class="col-md-12">
									<div class="form-group">
										<br> <br>  
										<div onclick="lock_perawatan()" id="lock_perawatan"  class="btn btn-warning pull-right" style="margin-right:5px">Lock</div>
									</div>
								</div>
							</form>
						</div>
							...
							<div class="row">
								<div class="col-md-12" style="margin-top: 30px">  
									...
									<div class="col-md-2" id="bahan_baku">
										...
										<select id="kode_bahan" name="kode_bahan" class="form-control" style="width: 100%" required="">
								...
								<a onclick="tambah_perawatan()"  class="btn btn-success pull-right komposisi_perawatan">Simpan</a>
...
<script type="text/javascript">
	...
	function cek_kode(){
		...
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'setting/perawatan/cek_kode_promo' ?>",  
			data :{ kode_perawatan:kode_perawatan},
			dataType: 'Json',
			success : function(data) { 
