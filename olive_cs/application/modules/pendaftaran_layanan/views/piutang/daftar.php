		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-right">
					<span class="pull-left" style="font-size: 24px">Data Piutang </span>
					...
					<div class="col-md-12" style="margin-top: 20px;">
						<table id="datatable" class="table table-striped table-bordered">
							...
							<tbody>
								...
								$this->db_master->where('kategori_member', 'Member Umum');
								...
								foreach ($hasil_member as $member) {
									...
									<tr>
										...
										<td>
											<a href="<?php echo base_url().'penjualan/piutang/detail/'.@$member->kode_member;?>" class="btn btn-icon waves-effect btn-no-radius waves-light btn-success m-b-5">
