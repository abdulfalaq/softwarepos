		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-left">
					...
					<a href="<?php echo base_url('penjualan/member_konsinyasi/record_transaksi_member'); ?>" class=" btn btn-primary btn-no-radius pull-right"><i class="fa fa-list"></i> Data Record Transaksi</a>
				</div>
