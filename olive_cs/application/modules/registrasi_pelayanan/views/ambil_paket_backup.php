												...
												<table style="white-space: nowrap;" id="data" class="table table-bordered  table-hover">
													<thead>
														<tr>
															...
															<th style="background-color:#229fcd; color:white" class="text-left" width="250px">QTY Diambil</th>
													...
													<tbody>
														...
														<tr>
															...
															<td>
																<input type="text"  required value="<?php echo $value->qty_diambil ?>" onkeyup="qty_terambil('<?php echo $value->id ?>')" class="form-control" name="qty_diambil_<?php echo $value->id ?>" id="qty_diambil_<?php echo $value->id ?>">
															</td>
															<td>
