		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-right">
					<span class="pull-left" style="font-size: 24px">Detail Stok Out</span>
				...
				$this->db->where('kode_stok_out', $kode_stok_out);
				$this->db->where('kode_unit_jabung', $hasil_unit->kode_unit);
				$get_stok_out=$this->db->get('transaksi_stok_out');
				$hasil_stok_out=$get_stok_out->row();
				?>
