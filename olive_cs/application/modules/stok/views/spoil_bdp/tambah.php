						...
						<div class="col-md-12 row">
							<table id="" class="table table-striped table-bordered">
								...
								<tbody>
									...
									$this->db->where('kan_master.master_barang_dalam_proses.kode_unit_jabung', @$hasil_unit->kode_unit);
									...
									foreach ($hasil_bb as $bahan) {
										...
										<tr>
											...
											<td class="text-center">
												<input name="opsi_spoil[]" type="checkbox" id="opsi_pilihan" value="<?php echo @$bahan->kode_barang;?>">
											</td>
										</tr>
										<?php
									}
...
<script type="text/javascript">
	function simpan_spoil(){
		...
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'stok/spoil_bdp/simpan_temp' ?>",  
			cache :false,  
			...
			success : function(data) { 
				window.location="<?php echo base_url() . 'stok/spoil_bdp/tambah_spoil/' ?>"+kode_spoil;
			},  
			error : function() {
