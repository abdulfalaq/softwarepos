		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-right">
					...
					<a href="<?php echo base_url('stok/spoil_bb/tambah'); ?>" class="btn btn-success btn-no-radius"><i class="fa fa-plus"></i> Tambah Spoil</a>
					<a href="<?php echo base_url('stok/spoil_bb/daftar'); ?>" class="btn btn-primary btn-no-radius"><i class="fa fa-list"></i> Data Spoil</a>
				</div>
						...
						<div class="col-md-12 row">
							<table id="" class="table table-striped table-bordered">
								...
								<tbody>
									...
									$this->db->where('kan_master.master_bahan_baku.kode_unit_jabung', @$hasil_unit->kode_unit);
									...
									foreach ($hasil_bb as $bahan) {
										...
										<tr>
											<td><?php echo $no++;?></td>
											<td><?php echo @$bahan->nama_bahan_baku;?></td>
											<td><?php echo @$bahan->real_stok.' '.@$bahan->nama;?></td>
											<td class="text-center">
												<input name="opsi_spoil[]" type="checkbox" id="opsi_pilihan" value="<?php echo @$bahan->kode_bahan_baku;?>">
											</td>
										</tr>
										<?php
									}
...
<script type="text/javascript">
	function simpan_spoil(){
		...
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'stok/spoil_bb/simpan_temp' ?>",  
			cache :false,  
			...
			success : function(data) { 
				window.location="<?php echo base_url() . 'stok/spoil_bb/tambah_spoil/' ?>"+kode_spoil;
			},  
			error : function() {
