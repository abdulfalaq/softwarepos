						...
						<div class="box-body">            
							<div class="row">
								<div class="form-group  col-xs-5">
									<label><b>Kode Perlengkapan</b></label>
									<input  type="text" class="form-control" name="kode_perlengkapan" id="kode_perlengkapan"  required readonly="" value="<?php echo $get_gudang->kode_perlengkapan ?>">
								</div>
								<div class="form-group  col-xs-5">
									<label class="gedhi"><b>Satuan Stok</b></label>
									<select class="form-control" name="kode_satuan_stok" id="kode_satuan_stok" required="" >
								...
								<div class="form-group  col-xs-5">
									<label class="gedhi"><b>Nama Perlengkapan</b></label>
									<input type="text" class="form-control" id="nama_perlengkapan" name="nama_perlengkapan" required="" value="<?php echo $get_gudang->nama_perlengkapan ?>">
								</div>

								<div class="form-group  col-xs-5">
									<label class="gedhi"><b>Kode Rak</b></label>
								...
								<div class="form-group  col-xs-5">
									<label class="gedhi"><b>Minimal Stok</b></label>
									<input type="number" class="form-control" name="stok_minimal" id="stok_minimal" required=""  value="<?php echo $get_gudang->stok_minimal ?>">
								</div>
								<div class="form-group col-xs-5">
									<label class="gedhi"><b>Status</b></label>
							...
							<div class="form-group  col-xs-5">
								<label class="gedhi"><b>HPP</b></label>
								<div class="input-group">
									<span class="input-group-addon r_nm"><?php echo format_rupiah($get_gudang->hpp) ?></span>
									<input type="number" class="form-control input-group" onkeyup="get_nominal_hpp()"  value="<?php echo $get_gudang->hpp; ?>" required="" name="hpp" id="hpp" />
								</div>
							</div>
						</div>
...
<script type="text/javascript">
	...
	$("#formGudang").submit( function() {        
		$.ajax( {  
			type :"post",  
			url : "<?php echo base_url() . 'setting/perlengkapan/update_member' ?>",  
			cache :false,  
			data :$(this).serialize(),
			dataType: 'Json',
			beforeSend:function(){
