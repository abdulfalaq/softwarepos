		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-right">
					<span class="pull-left" style="font-size: 24px">Tambah Kategori Produk </span>
						...
						<div class="box-body">            
							<div class="row">
								<div class="form-group  col-xs-6">
									...
									<input name="kode_kategori_produk" value="KP0004" readonly="true" type="text" class="form-control" id="kode_kategori_produk"/>
								</div>
								<div class="form-group  col-xs-6">
									<label class="gedhi"><b>Nama Kategori Produk</label>
									<input value="" type="text" class="form-control" name="nama_kategori_produk" />
									<input value="" type="hidden" class="form-control" name="id" />
								</div>
								<div class="form-group  col-xs-6">
									<label class="gedhi"><b>Keterangan</label>
									<input value="" type="text" class="form-control" name="keterangan" />
								</div>
							</div>
