...
<div class="container">
	...
	$this->db->where('olive_gudang.transaksi_hutang.kode_supplier',$kode_supplier);
	$this->db->from('olive_gudang.transaksi_hutang');
	$this->db->join('olive_gudang.transaksi_pembelian', 'olive_gudang.transaksi_hutang.kode_transaksi = olive_gudang.transaksi_pembelian.kode_pembelian', 'left');
	$this->db->join('olive_master.master_supplier', 'olive_gudang.transaksi_hutang.kode_supplier = olive_master.master_supplier.kode_supplier', 'left');
							...
							<table id="tabel_daftar" class="table table-bordered table-striped">
								...
								<tbody id="tabel_temp_data_transaksi">
									...
									if(@$get_hutang->kode_transaksi){
										...
										$this->db->select('olive_gudang.opsi_transaksi_pembelian.id');
										$this->db->select('olive_gudang.opsi_transaksi_pembelian.jumlah');
										$this->db->select('olive_gudang.opsi_transaksi_pembelian.expired_date');
