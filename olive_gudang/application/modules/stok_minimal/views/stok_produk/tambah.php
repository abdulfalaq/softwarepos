						...
						<div class="box-body">            
							<div class="row">
								<div class="form-group  col-xs-5">
									...
									<input  type="text" class="form-control" value="" name="kode_produk" id="kode_produk" />
								</div>
								<div class="form-group  col-xs-5">
								...
								<div class="form-group  col-xs-5">
									...
									<input  value="" type="text" class="form-control" name="nama_produk" />
								</div>
								<div class="form-group  col-xs-5">
									<label class="gedhi"><b>Minimal Stok</label>
									<input  type="number" class="form-control" name="stok_minimal" id="stok_minimal" value="" />
								</div>
								...
								<div class="form-group  col-xs-5">
									...
									<div class="input-group">
										...
										<input  type="number" class="form-control input-group" onkeyup="get_nominal_hpp()" name="harga_jual" id="harga_jual" value="" />
									</div>
								</div>
								...
								<div class="form-group  col-xs-5">
									...
									<div class="input-group">
										...
										<input  type="number" class="form-control input-group" onkeyup="get_nominal_insetif()" name="insentif_masker" id="insentif_masker" value="" />
									</div>
								</div>
								<div class="form-group  col-xs-5">
