			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-heading text-right">
						<span class="pull-left" style="font-size: 24px">Data Produk Simpanan Wajib</span>
					...
					<div class="panel-body">
						<table id="datatables" class="table table-bordered table-blue">
							...
							<tbody>
								...
								$sql = $this->db->get('master_simpanan_wajib');
								$item = $sql->result();
								...
								<tr>
									...
									<td><?php echo @format_rupiah($item->nominal_simpanan_wajib); ?></td>
									<td><?php echo @tanggalIndo($item->tanggal_aktivasi); ?></td>
									<td align="center" width="100px">
										<a href="<?php echo @base_url('setting/produk_simpanan_wajib/edit')."/".$item->id; ?>" data-toggle="tooltip" title="Edit" class="btn btn-warning"><i class="fa fa-edit"></i></a>
...
<script type="text/javascript">
	...
	function act_delete(){
		$.ajax({
			url: '<?php echo base_url('setting/produk_simpanan_wajib/act_delete'); ?>',
			type: 'post',
