			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-sm-6">
						...
						$no_akun = $hasil_nomer->no_akun_modal;
                ...
                // echo $nomor;
						...
						<table width="100%" class="table-form">
							...
							<tr>
								...
								<td><input type="text" name="no_akun" readonly="" value="<?php echo @$hasil_nomer->no_akun_modal ?>" id="no_akun" class="form-control" required=""></td>
							</tr>
				...
				<div class="panel-footer text-right">
					<a href="<?php echo base_url().'setting/setting_rekening/daftar_modal' ?>" class="btn btn-lg btn-super btn-no-radius btn-primary"><i class="fa fa-save"></i> SIMPAN</a>
				</div>
			</div>
		</div>
	</div> <!-- //row -->
...
<script type="text/javascript">
	...
	function add_item(){
		...
		if (kode_akun == '') {
			...
			$.ajax({
				type: "POST",
				url : "<?php echo base_url() . 'setting/setting_rekening/add_item_modal' ?>",  
				data: { 
					kode_akun:kode_akun,
					no_akun:no_akun,
