		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				<div class="panel-heading text-right">
					<span class="pull-left" style="font-size: 20px;">Tambah Setting</span>
					<a href="<?php echo @base_url('setting/setting_rekening/get_nomer'); ?>" type="button" class="btn btn-no-radius btn-success"><i class="fa fa-gear"></i> Setting</a>
					<a href="<?php echo @base_url('setting/setting_rekening/tambah_harta'); ?>" type="button" class="btn btn-no-radius btn-success"><i class="fa fa-plus"></i> Tambah Harta</a>
					<a href="<?php echo @base_url('setting/setting_rekening/daftar_harta'); ?>" type="button" class="btn btn-no-radius btn-primary"><i class="fa fa-list"></i> Daftar Harta</a>
				</div>
				<div class="panel-body">
					<div class="col-sm-6">
						...
						$no_akun = $hasil_nomer->no_akun_harta;
                ...
                // echo $nomor;
						...
						<table width="100%" class="table-form">
							...
							<tr>
								...
								<td><input type="text" name="no_akun" readonly="" value="<?php echo @$hasil_nomer->no_akun_harta ?>" id="no_akun" class="form-control" required=""></td>
							</tr>
				...
				<div class="panel-footer text-right">
					<a href="<?php echo base_url().'setting/setting_rekening/daftar_harta' ?>" class="btn btn-lg btn-super btn-no-radius btn-primary"><i class="fa fa-save"></i> SIMPAN</a>
				</div>
			</div>
		</div>
	</div> <!-- //row -->
